...
try {
  ...
  assert.match(gameJs, /berryBlizzard/, 'Berry Blizzard frenzy should exist');
  assert.match(gameJs, /cupcakeParade/, 'Cupcake Parade frenzy should exist');
  assert.match(gameJs, /pineappleStampede/, 'Pineapple Stampede frenzy should exist');
  assert.match(gameJs, /const FESTIVAL_FRENZY_KINDS/, 'festival events should have a randomizable kind list');
  assert.match(gameJs, /function pickFestivalFrenzyKind/, 'each festival trigger should pick a randomized frenzy kind');
  assert.match(gameJs, /function buildFestivalEvents/, 'festival events should be generated into the track');
  assert.match(gameJs, /kind: pickFestivalFrenzyKind/, 'festival events should not be hardcoded to melon rolls');
  ...
  assert.match(gameJs, /function drawBerryBlizzardFrenzy/, 'Berry Blizzard should have a custom visual renderer');
  assert.match(gameJs, /function drawCupcakeParadeFrenzy/, 'Cupcake Parade should have a custom visual renderer');
  assert.match(gameJs, /function drawPineappleStampedeFrenzy/, 'Pineapple Stampede should have a custom visual renderer');
  assert.match(gameJs, /Festival Frenzy/, 'festival events should announce themselves to the player');
  assert.match(gameJs, /Festival cleared/, 'surviving any festival event should award a bonus');
